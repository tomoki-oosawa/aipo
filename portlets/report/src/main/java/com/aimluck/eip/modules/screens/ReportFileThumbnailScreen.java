...
/**
 * 報告書の添付ファイルのサムネイルを処理するクラスです。
 */
public class ReportFileThumbnailScreen extends FileuploadThumbnailScreen {

  /** logger */
  private static final JetspeedLogger logger = JetspeedLogFactoryService
    .getLogger(ReportFileThumbnailScreen.class.getName());
  ...
  protected void doOutput(RunData rundata) throws Exception {
    try {
      ...
      super.setFile(reportfile.getFileThumbnail());
