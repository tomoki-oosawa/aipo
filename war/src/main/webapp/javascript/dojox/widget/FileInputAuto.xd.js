...
depends: [["provide", "dojox.widget.FileInputAuto"],
["require", "dojox.widget.FileInput"],
["require", "dojo.io.iframe"]],
defineResource: function(dojo){if(!dojo._hasResource["dojox.widget.FileInputAuto"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
