 ...
 *
 */
public class NoteAdminSelectData extends
  ...
  protected Object getResultDataDetail(PortletEntry record)
      throws ALPageNotFoundException, ALDBErrorException {
    NoteAdminDetailResultData rd = new NoteAdminDetailResultData(record);
    rd.initField();
    return rd;
  }
  ...
  public PortletEntry selectDetail(RunData rundata, Context context)
    ...
    return CustomizeUtils.getPortletEntry(rundata, NoteUtils.NOTE_PORTLET_NAME);
  }
