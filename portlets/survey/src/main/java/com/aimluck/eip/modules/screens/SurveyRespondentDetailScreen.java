 ...
 * 
 */
public class SurveyRespondentDetailScreen extends ALVelocityScreen {
  ...
  protected void doOutput(RunData rundata, Context context) throws Exception {
    ...
    try {
      SurveySelectData detailData = new SurveySelectData();
      detailData.initField();
      detailData.doViewDetail(this, rundata, context);
      String layout_template =
        "portlets/html/ja/ajax-survey-respondent-detail.vm";
