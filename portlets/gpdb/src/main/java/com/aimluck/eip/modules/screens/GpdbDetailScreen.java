 ...
 *
 */
public class GpdbDetailScreen extends ALVelocityScreen {

  /** logger */
  private static final JetspeedLogger logger = JetspeedLogFactoryService
    .getLogger(GpdbDetailScreen.class.getName());
  ...
  protected void doOutput(RunData rundata, Context context) throws Exception {
    try {
      GpdbSelectData detailData = new GpdbSelectData();
      ...
      String layout_template = "portlets/html/ja/ajax-gpdb-detail.vm";

      setTemplate(rundata, context, layout_template);
    } catch (Exception ex) {
      logger.error("[GpdbDetailScreen] Exception.", ex);
