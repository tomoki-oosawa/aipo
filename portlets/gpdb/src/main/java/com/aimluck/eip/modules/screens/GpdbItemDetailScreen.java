 ...
 *
 */
public class GpdbItemDetailScreen extends ALVelocityScreen {

  /** logger */
  private static final JetspeedLogger logger = JetspeedLogFactoryService
    .getLogger(GpdbItemDetailScreen.class.getName());
  ...
  protected void doOutput(RunData rundata, Context context) throws Exception {
    try {
      GpdbItemSelectData detailData = new GpdbItemSelectData();
      ...
      String layout_template = "portlets/html/ja/ajax-gpdb-item-detail.vm";

      setTemplate(rundata, context, layout_template);
    } catch (Exception ex) {
      logger.error("[GpdbItemDetailScreen] Exception.", ex);
