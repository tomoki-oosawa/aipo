...
depends: [["provide", "dojox.charting.Element"]],
defineResource: function(dojo){if(!dojo._hasResource["dojox.charting.Element"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
