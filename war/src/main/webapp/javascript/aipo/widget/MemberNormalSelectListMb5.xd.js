...
depends: [["provide", "aipo.widget.MemberNormalSelectListMb5"],
["require", "dijit._Widget"],
["require", "dijit._Templated"]],
defineResource: function(dojo){if(!dojo._hasResource["aipo.widget.MemberNormalSelectListMb5"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
dojo._hasResource["aipo.widget.MemberNormalSelectListMb5"] = true;
/*
...
dojo.provide("aipo.widget.MemberNormalSelectListMb5");
...
dojo.declare("aipo.widget.MemberNormalSelectListMb5", [dijit._Widget, dijit._Templated], {
    widgetId:"",
    memberFromId: "",
    memberFromUrl: "",
    memberFromOptionKey: "",
