...
import com.aimluck.eip.timeline.TimelineAdminFormData;

/**
 *
 */
public class TimelineAdminJSONScreen extends ALJSONScreen {
  ...
  protected String getJSONString(RunData rundata, Context context)
    ...
    try {
      if (ALEipConstants.MODE_UPDATE.equals(mode)) {
        TimelineAdminFormData formData = new TimelineAdminFormData();
        formData.initField();
