 ...
 *
 */
public class ProjectAdminSelectData extends
  ...
  protected Object getResultDataDetail(PortletEntry record)
      throws ALPageNotFoundException, ALDBErrorException {
    ProjectAdminDetailResultData rd = new ProjectAdminDetailResultData(record);
    rd.initField();
    return rd;
  }
  ...
  public PortletEntry selectDetail(RunData rundata, Context context)
    ...
    return CustomizeUtils.getPortletEntry(rundata, "Project");
  }
