...
depends: [["provide", "dojox.wire.ml.Transfer"],
["provide", "dojox.wire.ml.ChildWire"],
["provide", "dojox.wire.ml.ColumnWire"],
["provide", "dojox.wire.ml.NodeWire"],
["provide", "dojox.wire.ml.SegmentWire"],
["require", "dijit._Widget"],
["require", "dijit._Container"],
["require", "dojox.wire._base"],
["require", "dojox.wire.ml.Action"]],
defineResource: function(dojo){if(!dojo._hasResource["dojox.wire.ml.Transfer"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
