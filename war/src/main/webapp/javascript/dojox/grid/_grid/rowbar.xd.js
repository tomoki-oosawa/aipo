...
depends: [["provide", "dojox.grid._grid.rowbar"],
["require", "dojox.grid._grid.view"]],
defineResource: function(dojo){if(!dojo._hasResource["dojox.grid._grid.rowbar"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
