 ...
 *
 */
public class GpdbKubunDetailScreen extends ALVelocityScreen {

  /** logger */
  private static final JetspeedLogger logger = JetspeedLogFactoryService
    .getLogger(GpdbKubunDetailScreen.class.getName());
  ...
  protected void doOutput(RunData rundata, Context context) throws Exception {
    try {
      GpdbKubunSelectData detailData = new GpdbKubunSelectData();
      ...
      logger.error("[GpdbKubunDetailScreen] Exception.", ex);
