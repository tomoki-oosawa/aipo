...
depends: [["provide", 'dojox.grid._data.model'],
["require", 'dojox.grid._data.fields']],
defineResource: function(dojo){if(!dojo._hasResource['dojox.grid._data.model']){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
