...
depends: [["provide", "dojox.charting.themes.PlotKit.blue"],
["require", "dojox.charting.Theme"]],
defineResource: function(dojo){if(!dojo._hasResource["dojox.charting.themes.PlotKit.blue"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
