...
depends: [["provide", "dojox.presentation._base"],
...
["require", "dojo.fx"]],
defineResource: function(dojo){if(!dojo._hasResource["dojox.presentation._base"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
