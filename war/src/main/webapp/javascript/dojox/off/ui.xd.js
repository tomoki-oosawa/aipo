...
depends: [["provide", "dojox.off.ui"],
["require", "dojox.storage.Provider"],
["require", "dojox.storage.manager"],
["require", "dojox.storage.GearsStorageProvider"]],
defineResource: function(dojo){if(!dojo._hasResource["dojox.off.ui"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
