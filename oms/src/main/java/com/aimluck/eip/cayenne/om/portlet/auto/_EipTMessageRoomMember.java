...
/**
 * Class _EipTMessageRoomMember was generated by Cayenne. It is probably a good
 ...
 * subclass.
 */
public class _EipTMessageRoomMember extends
    org.apache.cayenne.CayenneDataObject {

  public static final String AUTHORITY_PROPERTY = "authority";

  public static final String DESKTOP_NOTIFICATION_PROPERTY =
    "desktop_notification";

  public static final String MOBILE_NOTIFICATION_PROPERTY =
    "mobile_notification";
  ...
  public void setDesktopNotification(String desktop_notification) {
    writeProperty("desktop_notification", desktop_notification);
  }

  public String getDesktopNotification() {
    return (String) readProperty("desktop_notification");
  }

  public void setMobileNotification(String mobile_notification) {
    writeProperty("mobile_notification", mobile_notification);
  }

  public String getMobileNotification() {
    return (String) readProperty("mobile_notification");
  }
