...
depends: [["provide", "dojox.gfx.arc"],
["require", "dojox.gfx.matrix"]],
defineResource: function(dojo){if(!dojo._hasResource["dojox.gfx.arc"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
