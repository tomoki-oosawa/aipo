...
depends: [["provide", "dijit.form.ComboBox"],
["require", "dojo.data.ItemFileReadStore"],
["require", "dijit.form.ValidationTextBox"],
["requireLocalization", "dijit.form", "ComboBox", null, "ROOT,cs,de,es,fr,hu,it,ja,ko,pl,pt,ru,zh,zh-tw", "ROOT,cs,de,es,fr,hu,it,ja,ko,pl,pt,ru,zh,zh-tw"]],
defineResource: function(dojo){if(!dojo._hasResource["dijit.form.ComboBox"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
