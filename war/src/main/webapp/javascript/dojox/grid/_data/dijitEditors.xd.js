...
depends: [["provide", "dojox.grid._data.dijitEditors"],
...
defineResource: function(dojo){if(!dojo._hasResource["dojox.grid._data.dijitEditors"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
