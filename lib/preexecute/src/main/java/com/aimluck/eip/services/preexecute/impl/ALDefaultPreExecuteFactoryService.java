...
import com.aimluck.eip.services.preexecute.impl.ALDefaultPreExecuteHanlder;

/**
 *
 */
public class ALDefaultPreExecuteFactoryService extends
    ALPreExecuteFactoryService {

  @SuppressWarnings("unused")
  private static final JetspeedLogger logger = JetspeedLogFactoryService
    .getLogger(ALDefaultPreExecuteFactoryService.class.getName());
