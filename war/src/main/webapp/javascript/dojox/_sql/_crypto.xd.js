...
depends: [["provide", "dojox._sql._crypto"]],
defineResource: function(dojo){if(!dojo._hasResource["dojox._sql._crypto"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
