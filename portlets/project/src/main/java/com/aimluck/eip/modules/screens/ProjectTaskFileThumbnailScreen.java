 ...
 */
public class ProjectTaskFileThumbnailScreen extends FileuploadThumbnailScreen {

  /** logger */
  private static final JetspeedLogger logger = JetspeedLogFactoryService
    .getLogger(ProjectTaskFileThumbnailScreen.class.getName());
  ...
  protected void doOutput(RunData rundata) throws Exception {
    try {
      EipTProjectTaskFile taskfile =
        pfile.getEipTFile(rundata, EipTProjectTaskFile.FILE_ID_PK_COLUMN);

      super.setFile(taskfile.getFileThumbnail());
      super.setFileName(taskfile.getFileName());
