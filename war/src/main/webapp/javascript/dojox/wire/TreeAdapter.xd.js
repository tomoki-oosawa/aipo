...
depends: [["provide", "dojox.wire.TreeAdapter"],
["require", "dojox.wire.CompositeWire"]],
defineResource: function(dojo){if(!dojo._hasResource["dojox.wire.TreeAdapter"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
