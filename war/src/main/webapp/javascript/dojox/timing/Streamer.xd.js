...
depends: [["provide", "dojox.timing.Streamer"],
["require", "dojox.timing._base"]],
defineResource: function(dojo){if(!dojo._hasResource["dojox.timing.Streamer"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
