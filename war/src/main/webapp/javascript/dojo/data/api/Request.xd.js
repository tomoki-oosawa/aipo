...
depends: [["provide", "dojo.data.api.Request"]],
defineResource: function(dojo){if(!dojo._hasResource["dojo.data.api.Request"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
