...
depends: [["provide", "dijit._editor.plugins.AlwaysShowToolbar"]],
defineResource: function(dojo){if(!dojo._hasResource["dijit._editor.plugins.AlwaysShowToolbar"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
