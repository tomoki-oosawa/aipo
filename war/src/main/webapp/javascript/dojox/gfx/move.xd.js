...
depends: [["provide", "dojox.gfx.move"]],
defineResource: function(dojo){if(!dojo._hasResource["dojox.gfx.move"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
