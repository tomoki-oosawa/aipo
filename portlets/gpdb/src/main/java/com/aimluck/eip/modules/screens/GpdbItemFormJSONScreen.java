...
import com.aimluck.eip.gpdb.GpdbItemMultiDelete;

/**
 *
 */
public class GpdbItemFormJSONScreen extends ALJSONScreen {

  /** logger */
  private static final JetspeedLogger logger = JetspeedLogFactoryService
    .getLogger(GpdbItemFormJSONScreen.class.getName());
  ...
  protected String getJSONString(RunData rundata, Context context)
    ...
    try {
      if (ALEipConstants.MODE_INSERT.equals(mode)) {
        ...
        // 一覧削除
        GpdbItemMultiDelete delete = new GpdbItemMultiDelete();
      ...
      logger.error("[GpdbItemFormJSONScreen]", e);
    }
