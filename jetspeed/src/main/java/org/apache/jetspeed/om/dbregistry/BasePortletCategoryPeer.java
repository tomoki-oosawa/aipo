...
public abstract class BasePortletCategoryPeer extends BasePeer {
   ...
   *
   */
  private static final long serialVersionUID = -3160859179055338633L;
   ...
   *           into a TorqueException.
   */
  public static List<BaseObject> doSelect(PortletCategory obj)
      throws TorqueException {
    ...
    for (int i = 0; i < rows.size(); i++) {
      ...
      for (int j = 0; j < results.size(); j++) {
        ...
        PortletDbEntry temp_obj2 =
          ((BasePortletCategory) temp_obj1).getPortletDbEntry();
