...
depends: [["provide", "dojo.fx"],
["provide", "dojo.fx.Toggler"]],
defineResource: function(dojo){if(!dojo._hasResource["dojo.fx"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
