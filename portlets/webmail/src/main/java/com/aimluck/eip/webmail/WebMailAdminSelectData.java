 ...
 *
 */
public class WebMailAdminSelectData extends
  ...
  protected Object getResultDataDetail(PortletEntry record)
      throws ALPageNotFoundException, ALDBErrorException {
    WebMailAdminDetailResultData rd = new WebMailAdminDetailResultData(record);
    rd.initField();
    return rd;
  }
  ...
  public PortletEntry selectDetail(RunData rundata, Context context)
    ...
    return CustomizeUtils.getPortletEntry(rundata, "WebMail");
  }
