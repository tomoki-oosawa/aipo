 ...
 * 
 */
public class WikiCategoryFormJSONScreen extends ALJSONScreen {

  /** logger */
  private static final JetspeedLogger logger = JetspeedLogFactoryService
    .getLogger(WikiCategoryFormJSONScreen.class.getName());
  ...
  protected String getJSONString(RunData rundata, Context context)
    ...
    try {
      ...
      if (ALEipConstants.MODE_INSERT.equals(mode)) {
        ...
        // WikiCategoryMultiDelete delete = new WikiCategoryMultiDelete();
      ...
      logger.error("[WikiCategoryFormJSONScreen]", e);
    }
