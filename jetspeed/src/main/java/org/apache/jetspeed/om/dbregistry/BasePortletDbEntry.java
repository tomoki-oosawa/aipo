...
public abstract class BasePortletDbEntry extends BaseObject {
   ...
   *
   */
  private static final long serialVersionUID = 2052685054965557648L;
  ...
  public void setId(long v) throws TorqueException {
    ...
    if (collPortletCategorys != null) {
      for (int i = 0; i < collPortletCategorys.size(); i++) {
        ((PortletCategory) collPortletCategorys.get(i)).setOwner(v);
      }
    }
    ...
    if (collPortletParameters != null) {
      for (int i = 0; i < collPortletParameters.size(); i++) {
        ((PortletParameter) collPortletParameters.get(i)).setPortletId(v);
      }
    }
    ...
    if (collPortletMediatypes != null) {
      for (int i = 0; i < collPortletMediatypes.size(); i++) {
        ((PortletMediatype) collPortletMediatypes.get(i)).setId(v);
      }
    }
  }
   ...
   */
  protected List<BaseObject> collPortletCategorys;
  ...
  protected void initPortletCategorys() {
    if (collPortletCategorys == null) {
      collPortletCategorys = new ArrayList<BaseObject>();
    }
  }
   ...
   */
  public List<BaseObject> getPortletCategorys() throws TorqueException {
    if (collPortletCategorys == null) {
   ...
   */
  public List<BaseObject> getPortletCategorys(Criteria criteria)
   ...
   * taken as input
   */
  public List<BaseObject> getPortletCategorys(Connection con)
      throws TorqueException {
    if (collPortletCategorys == null) {
   ...
   */
  public List<BaseObject> getPortletCategorys(Criteria criteria, Connection con)
      throws TorqueException {
    if (collPortletCategorys == null) {
      if (isNew()) {
        collPortletCategorys = new ArrayList<BaseObject>();
   ...
   * PortletDbEntry.
   */
  protected List<BaseObject> getPortletCategorysJoinPortletDbEntry(
   ...
   */
  protected List<BaseObject> collPortletParameters;
  ...
  protected void initPortletParameters() {
    if (collPortletParameters == null) {
      collPortletParameters = new ArrayList<BaseObject>();
    }
  }
   ...
   */
  public List<BaseObject> getPortletParameters() throws TorqueException {
    if (collPortletParameters == null) {
   ...
   */
  public List<BaseObject> getPortletParameters(Criteria criteria)
      throws TorqueException {
    if (collPortletParameters == null) {
      if (isNew()) {
        collPortletParameters = new ArrayList<BaseObject>();
   ...
   * taken as input
   */
  public List<BaseObject> getPortletParameters(Connection con)
      throws TorqueException {
    if (collPortletParameters == null) {
   ...
   */
  public List<BaseObject> getPortletParameters(Criteria criteria, Connection con)
      throws TorqueException {
    if (collPortletParameters == null) {
      if (isNew()) {
        collPortletParameters = new ArrayList<BaseObject>();
   ...
   * PortletDbEntry.
   */
  protected List<BaseObject> getPortletParametersJoinPortletDbEntry(
      Criteria criteria) throws TorqueException {
    if (collPortletParameters == null) {
      if (isNew()) {
        collPortletParameters = new ArrayList<BaseObject>();
   ...
   */
  protected List<BaseObject> collPortletMediatypes;
  ...
  protected void initPortletMediatypes() {
    if (collPortletMediatypes == null) {
      collPortletMediatypes = new ArrayList<BaseObject>();
    }
  }
   ...
   */
  public List<BaseObject> getPortletMediatypes() throws TorqueException {
    if (collPortletMediatypes == null) {
   ...
   * current collection, the criteria is ignored on a new object.
   */
  public List<BaseObject> getPortletMediatypes(Criteria criteria)
      throws TorqueException {
    if (collPortletMediatypes == null) {
      if (isNew()) {
        collPortletMediatypes = new ArrayList<BaseObject>();
   ...
   * taken as input
   */
  public List<BaseObject> getPortletMediatypes(Connection con)
      throws TorqueException {
    if (collPortletMediatypes == null) {
   ...
   * be obtained using a Connection that is taken as input
   */
  public List<BaseObject> getPortletMediatypes(Criteria criteria, Connection con)
      throws TorqueException {
    if (collPortletMediatypes == null) {
      if (isNew()) {
        collPortletMediatypes = new ArrayList<BaseObject>();
   ...
   * PortletDbEntry.
   */
  protected List<BaseObject> getPortletMediatypesJoinPortletDbEntry(
      Criteria criteria) throws TorqueException {
    if (collPortletMediatypes == null) {
      if (isNew()) {
        collPortletMediatypes = new ArrayList<BaseObject>();
   ...
   * PortletDbEntry.
   */
  protected List<BaseObject> getPortletMediatypesJoinMediatype(Criteria criteria)
      throws TorqueException {
    if (collPortletMediatypes == null) {
      if (isNew()) {
        collPortletMediatypes = new ArrayList<BaseObject>();
  ...
  public PortletDbEntry copy() throws TorqueException {
    ...
    List<BaseObject> v = getPortletCategorys();
