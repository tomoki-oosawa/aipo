  ...
  protected boolean setFormData(RunData rundata, Context context,
    ...
    if (res) {
      try {
        ...
        /*
         * // 日付をまたぐ場合 if (is_span) { Calendar endDate = Calendar.getInstance();
         * endDate.setTime(end_date.getValue());
         * endDate.set(Calendar.HOUR_OF_DAY, Integer.parseInt(rundata
         * .getParameters() .get("end_date_hour")));
         * endDate.set(Calendar.MINUTE, Integer.parseInt(rundata
         * .getParameters() .get("end_date_minute")));
         * 
