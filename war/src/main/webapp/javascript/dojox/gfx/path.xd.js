...
depends: [["provide", "dojox.gfx.path"],
["require", "dojox.gfx.shape"]],
defineResource: function(dojo){if(!dojo._hasResource["dojox.gfx.path"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
