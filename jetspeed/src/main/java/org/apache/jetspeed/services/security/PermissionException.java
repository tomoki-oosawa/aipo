 ...
 * @version $Id: PermissionException.java,v 1.3 2004/02/23 03:58:11 jford Exp $
 */

public class PermissionException extends JetspeedSecurityException {

    /**
     * Constructs a PermissionException with no detail message. A detail
     ...
     *               to be thrown.
     */
    public PermissionException( String msg, Throwable nested )
    {
        super(msg, nested);
    }
