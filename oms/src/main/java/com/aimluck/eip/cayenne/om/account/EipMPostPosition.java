...
import com.aimluck.eip.cayenne.om.account.auto._EipMPostPosition;
import com.aimluck.eip.cayenne.om.security.TurbineUser;

public class EipMPostPosition extends _EipMPostPosition {
  ...
  public Integer getUserId() {
    ...
    if (user != null) {
      Object obj =
        getObjectId().getIdSnapshot().get(TurbineUser.USER_ID_PK_COLUMN);
