...
depends: [["provide", "dojox.crypto.Blowfish"],
["require", "dojox.crypto._base"]],
defineResource: function(dojo){if(!dojo._hasResource["dojox.crypto.Blowfish"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
