...
public abstract class BaseTurbineRolePermissionPeer extends BasePeer {
   ...
   *
   */
  private static final long serialVersionUID = 2671546651066894809L;
   ...
   *           into a TorqueException.
   */
  public static List<BaseObject> resultSet2Objects(java.sql.ResultSet results)
      throws TorqueException {
    try {
   ...
   *           into a TorqueException.
   */
  public static List<BaseObject> doSelect(TurbineRolePermission obj)
      throws TorqueException {
   ...
   *           into a TorqueException.
   */
  public static List<BaseObject> retrieveByPKs(List<?> pks)
      throws TorqueException {
    Connection db = null;
   ...
   *           into a TorqueException.
   */
  public static List<BaseObject> retrieveByPKs(List<?> pks, Connection dbcon)
      throws TorqueException {
   ...
   *          int
   */
  public static BaseObject retrieveByPK(int role_id, int permission_id)
      throws TorqueException {
    Connection db = null;
    BaseObject retVal = null;
    try {
    ...
    for (int i = 0; i < rows.size(); i++) {
      ...
      for (int j = 0; j < results.size(); j++) {
        ...
        TurbineRole temp_obj2 =
          ((BaseTurbineRolePermission) temp_obj1).getTurbineRole();
   ...
   *           into a TorqueException.
   */
  protected static List<BaseObject> doSelectJoinTurbinePermission(Criteria c)
      throws TorqueException {
    // Set the correct dbName if it has not been overridden
    // c.getDbName will return the same object if not set to
    // another value so == check is okay and faster
    ...
    for (int i = 0; i < rows.size(); i++) {
      ...
      for (int j = 0; j < results.size(); j++) {
        BaseObject temp_obj1 = results.get(j);
        TurbinePermission temp_obj2 =
          ((BaseTurbineRolePermission) temp_obj1).getTurbinePermission();
        if (temp_obj2.getPrimaryKey().equals(obj2.getPrimaryKey())) {
          newObject = false;
          temp_obj2.addTurbineRolePermission(obj1);
          break;
