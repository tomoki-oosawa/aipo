...
depends: [["provide", "dojox.data.QueryReadStore"],
["provide", "dojox.data.QueryReadStore.InvalidItemError"],
["provide", "dojox.data.QueryReadStore.InvalidAttributeError"],
["require", "dojo.string"],
["require", "dojo.data.util.simpleFetch"]],
defineResource: function(dojo){if(!dojo._hasResource["dojox.data.QueryReadStore"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
