...
depends: [["provide", "dojox.widget.SortList"],
["require", "dijit.layout._LayoutWidget"],
["require", "dijit._Templated"]],
defineResource: function(dojo){if(!dojo._hasResource["dojox.widget.SortList"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
