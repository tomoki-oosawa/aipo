...
depends: [["provide", "dojox.image.ThumbnailPicker"],
["require", "dojo.fx"],
["require", "dijit._Widget"],
["require", "dijit._Templated"],
["require", "dojox.fx.scroll"],
["require", "dojox.fx.easing"]],
defineResource: function(dojo){if(!dojo._hasResource["dojox.image.ThumbnailPicker"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
