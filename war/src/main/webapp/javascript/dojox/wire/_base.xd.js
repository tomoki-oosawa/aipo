...
depends: [["provide", "dojox.wire._base"]],
defineResource: function(dojo){if(!dojo._hasResource["dojox.wire._base"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
