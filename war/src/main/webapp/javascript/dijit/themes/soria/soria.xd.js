...
depends: [["provide", "dijit.themes.soria"]],
defineResource: function(dojo){if(!dojo._hasResource["dijit.themes.soria"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
