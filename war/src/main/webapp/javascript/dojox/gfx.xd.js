...
depends: [["provide", "dojox.gfx"],
["require", "dojox.gfx.matrix"],
["require", "dojox.gfx._base"],
["requireIf", dojox.gfx.renderer == "svg", "dojox.gfx.svg"],
["requireIf", dojox.gfx.renderer == "vml", "dojox.gfx.vml"],
["requireIf", dojox.gfx.renderer == "silverlight", "dojox.gfx.silverlight"],
["requireIf", dojox.gfx.renderer == "canvas", "dojox.gfx.canvas"]],
defineResource: function(dojo){if(!dojo._hasResource["dojox.gfx"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
