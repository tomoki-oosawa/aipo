...
depends: [["provide", "dojox.fx.style"],
["require", "dojox.fx._base"]],
defineResource: function(dojo){if(!dojo._hasResource["dojox.fx.style"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
