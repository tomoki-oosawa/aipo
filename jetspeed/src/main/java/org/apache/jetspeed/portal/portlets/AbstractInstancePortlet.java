...
/**
 * Extend AbstractPortlet to re-define the handle used for portlet caching: This
 * handle uses the portlet's unique id and the portal page's id to form a
 * portlet instance id for caching.
 * 
...
public class AbstractInstancePortlet extends AbstractPortlet {
   ...
   *
   */
  private static final long serialVersionUID = 9178583899610680031L;

  /**
   * Construct the handle used for caching.
   * 
   * @param config
   *          The config object, expected to be a PortletConfig.
   */
