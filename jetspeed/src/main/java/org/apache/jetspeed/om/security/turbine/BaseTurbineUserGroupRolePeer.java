...
public abstract class BaseTurbineUserGroupRolePeer extends BasePeer {
   ...
   *
   */
  private static final long serialVersionUID = 8791129104570395699L;
   ...
   *           into a TorqueException.
   */
  public static List<BaseObject> doSelect(Criteria criteria)
      throws TorqueException {
   ...
   *           into a TorqueException.
   */
  public static List<BaseObject> doSelect(Criteria criteria, Connection con)
      throws TorqueException {
   ...
   *           into a TorqueException.
   */
  public static List<BaseObject> populateObjects(List<?> records)
      throws TorqueException {
    List<BaseObject> results = new ArrayList<BaseObject>(records.size());
   ...
   *           into a TorqueException.
   */
  public static List<BaseObject> doSelect(TurbineUserGroupRole obj)
      throws TorqueException {
   ...
   *           Primary key was not found in database.
   */
  public static BaseObject retrieveByPK(ObjectKey pk) throws TorqueException,
   ...
   *           Primary key was not found in database.
   */
  public static BaseObject retrieveByPK(ObjectKey pk, Connection con)
      throws TorqueException, NoRowsException, TooManyRowsException {
    Criteria criteria = buildCriteria(pk);
    List<BaseObject> v = doSelect(criteria, con);
    if (v.size() == 0) {
   ...
   *           into a TorqueException.
   */
  public static List<BaseObject> retrieveByPKs(List<BaseObject> pks)
      throws TorqueException {
    Connection db = null;
  ...
  public static List<BaseObject> retrieveByPKs(List<BaseObject> pks,
    ...
    if (pks == null || pks.size() == 0) {
      objs = new LinkedList<BaseObject>();
    } else {
      Criteria criteria = new Criteria();
   ...
   *          int
   */
  public static BaseObject retrieveByPK(int user_id, int group_id, int role_id)
      throws TorqueException {
    Connection db = null;
    BaseObject retVal = null;
    try {
   ...
   *           into a TorqueException.
   */
  protected static List<BaseObject> doSelectJoinTurbineUser(Criteria c)
      throws TorqueException {
    // Set the correct dbName if it has not been overridden
    ...
    List<BaseObject> results = new ArrayList<BaseObject>();
    ...
    for (int i = 0; i < rows.size(); i++) {
      ...
      for (int j = 0; j < results.size(); j++) {
        BaseObject temp_obj1 = results.get(j);
        TurbineUser temp_obj2 =
          ((BaseTurbineUserGroupRole) temp_obj1).getTurbineUser();
   ...
   *           into a TorqueException.
   */
  protected static List<BaseObject> doSelectJoinTurbineGroup(Criteria c)
      throws TorqueException {
    // Set the correct dbName if it has not been overridden
    // c.getDbName will return the same object if not set to
    // another value so == check is okay and faster
    ...
    for (int i = 0; i < rows.size(); i++) {
      ...
      for (int j = 0; j < results.size(); j++) {
        BaseObject temp_obj1 = results.get(j);
        TurbineGroup temp_obj2 =
          ((BaseTurbineUserGroupRole) temp_obj1).getTurbineGroup();
        if (temp_obj2.getPrimaryKey().equals(obj2.getPrimaryKey())) {
          newObject = false;
          temp_obj2.addTurbineUserGroupRole(obj1);
          break;
   ...
   *           into a TorqueException.
   */
  protected static List<BaseObject> doSelectJoinTurbineRole(Criteria c)
      throws TorqueException {
    // Set the correct dbName if it has not been overridden
    // c.getDbName will return the same object if not set to
    // another value so == check is okay and faster
    ...
    for (int i = 0; i < rows.size(); i++) {
      ...
      for (int j = 0; j < results.size(); j++) {
        BaseObject temp_obj1 = results.get(j);
        TurbineRole temp_obj2 =
          ((BaseTurbineUserGroupRole) temp_obj1).getTurbineRole();
        if (temp_obj2.getPrimaryKey().equals(obj2.getPrimaryKey())) {
          newObject = false;
          temp_obj2.addTurbineUserGroupRole(obj1);
          break;
   ...
   *           into a TorqueException.
   */
  protected static List<BaseObject> doSelectJoinAllExceptTurbineUser(Criteria c)
      throws TorqueException {
    // Set the correct dbName if it has not been overridden
   ...
   *           into a TorqueException.
   */
  protected static List<BaseObject> doSelectJoinAllExceptTurbineGroup(Criteria c)
      throws TorqueException {
    // Set the correct dbName if it has not been overridden
    // c.getDbName will return the same object if not set to another value
    // so == check is okay and faster
   ...
   *           into a TorqueException.
   */
  protected static List<BaseObject> doSelectJoinAllExceptTurbineRole(Criteria c)
      throws TorqueException {
    // Set the correct dbName if it has not been overridden
    // c.getDbName will return the same object if not set to another value
    // so == check is okay and faster
