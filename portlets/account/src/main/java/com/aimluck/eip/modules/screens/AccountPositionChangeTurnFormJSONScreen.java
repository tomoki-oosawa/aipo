 ...
 *
 */
public class AccountPositionChangeTurnFormJSONScreen extends ALJSONScreen {

  /** logger */
  private static final JetspeedLogger logger = JetspeedLogFactoryService
    .getLogger(AccountPositionChangeTurnFormJSONScreen.class.getName());
  ...
  protected String getJSONString(RunData rundata, Context context)
    ...
    try {
      ...
      logger.error("["
        + AccountPositionChangeTurnFormJSONScreen.class.toString()
        + "]", e);
    }
