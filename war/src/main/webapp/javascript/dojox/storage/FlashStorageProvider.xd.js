...
depends: [["provide", "dojox.storage.FlashStorageProvider"],
["require", "dojox.flash"],
["require", "dojox.storage.manager"],
["require", "dojox.storage.Provider"]],
defineResource: function(dojo){if(!dojo._hasResource["dojox.storage.FlashStorageProvider"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
