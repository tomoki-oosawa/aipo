          ...
          [ aimluck.widget.Dropdown ],
          {
            ...
            _openDropDown : function() {
              if (dojo.byId("tutorial_activity") != null) {
                ...
                dojo.query("a", dojo.byId("tutorial_activity"))[0].click()
              }
              this.inherited(arguments);
              ...
              if (aipo.userAgent.isAndroid()) {
                ...
                var navigationNodes = dojo.query("input,select,button,a",
                    navigationElems);
                var auiWidgetsElems = dojo.byId("auiWidgetsArea");
                var auiWidgetsNodes = dojo.query("input,select,button,a",
                    auiWidgetsElems);
