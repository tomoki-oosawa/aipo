...
depends: [["provide", "dojox.off._common"],
["require", "dojox.storage"],
["require", "dojox.sql"],
["require", "dojox.off.sync"]],
defineResource: function(dojo){if(!dojo._hasResource["dojox.off._common"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
