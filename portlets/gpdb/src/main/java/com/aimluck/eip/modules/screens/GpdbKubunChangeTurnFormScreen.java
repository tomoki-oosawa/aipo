...
/**
 * 区分値の順番情報を処理するクラスです。 <br />
 * 
 */
public class GpdbKubunChangeTurnFormScreen extends ALVelocityScreen {

  /** logger */
  private static final JetspeedLogger logger = JetspeedLogFactoryService
    .getLogger(GpdbKubunChangeTurnFormScreen.class.getName());
  ...
  protected void doOutput(RunData rundata, Context context) throws Exception {
    ...
    try {
      ...
      logger.error("[GpdbKubunChangeTurnFormScreen] Exception.", ex);
  ...
  protected void doGpdbItem_form(RunData rundata, Context context) {
    ...
    GpdbKubunChangeTurnFormData formData = new GpdbKubunChangeTurnFormData();
    formData.initField();
