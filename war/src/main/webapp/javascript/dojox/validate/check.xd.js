...
depends: [["provide", "dojox.validate.check"],
["require", "dojox.validate._base"]],
defineResource: function(dojo){if(!dojo._hasResource["dojox.validate.check"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
