 ...
 *
 */
public class ExtTimecardSystemReportSettingFormJSONScreen extends ALJSONScreen {

  /** logger */
  private static final JetspeedLogger logger = JetspeedLogFactoryService
    .getLogger(ExtTimecardSystemReportSettingFormJSONScreen.class.getName());
  ...
  protected String getJSONString(RunData rundata, Context context)
    ...
    try {
      ...
      logger.error("[ExtTimecardSystemReportSettingFormJSONScreen]", e);
    }
