...
depends: [["provide", "dijit._tree.dndSelector"],
["require", "dojo.dnd.common"],
["require", "dijit._tree.dndContainer"]],
defineResource: function(dojo){if(!dojo._hasResource["dijit._tree.dndSelector"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
