...
depends: [["provide", "dojo.rpc.RpcService"]],
defineResource: function(dojo){if(!dojo._hasResource["dojo.rpc.RpcService"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
