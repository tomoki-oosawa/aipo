...
depends: [["provide", "aipo.widget.GroupNormalSelectListMb5"],
["require", "dijit._Widget"],
["require", "dijit._Templated"]],
defineResource: function(dojo){if(!dojo._hasResource["aipo.widget.GroupNormalSelectListMb5"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
dojo._hasResource["aipo.widget.GroupNormalSelectListMb5"] = true;
/*
...
dojo.provide("aipo.widget.GroupNormalSelectListMb5");
...
dojo.declare("aipo.widget.GroupNormalSelectListMb5", [dijit._Widget, dijit._Templated], {
    inputWidth: "95%",
    memberLimit: 0,
    changeGroupUrl: "",
    widgetId:"",
