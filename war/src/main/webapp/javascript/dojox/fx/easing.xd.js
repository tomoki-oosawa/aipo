...
depends: [["provide", "dojox.fx.easing"]],
defineResource: function(dojo){if(!dojo._hasResource["dojox.fx.easing"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
