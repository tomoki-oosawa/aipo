...
depends: [["provide", "dojox.widget.Iterator"],
["require", "dijit.Declaration"]],
defineResource: function(dojo){if(!dojo._hasResource["dojox.widget.Iterator"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
