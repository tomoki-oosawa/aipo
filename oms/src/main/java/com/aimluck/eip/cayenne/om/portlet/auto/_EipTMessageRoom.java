...
/**
 * Class _EipTMessageRoom was generated by Cayenne. It is probably a good idea
...
public class _EipTMessageRoom extends org.apache.cayenne.CayenneDataObject {
  ...
  public static final String EIP_TMESSAGE_ROOM_MEMBER_PROPERTY =
    "eipTMessageRoomMember";

  public static final String EIP_TMESSAGES_PROPERTY = "eipTMessages";

  public static final String ROOM_ID_PK_COLUMN = "ROOM_ID";

  public static final String Setting_Notification_Flag =
  ...
  public void setSettingNotification(String isSettingNotification) {
    writeProperty("isSettingNotification", isSettingNotification);
  }

  public String getSettingNotification() {
    return (String) readProperty("isSettingNotification");
  }
  ...
  public void addToEipTMessageRoomMember(
      com.aimluck.eip.cayenne.om.portlet.EipTMessageRoomMember obj) {
    addToManyTarget("eipTMessageRoomMember", obj, true);
  }

  public void removeFromEipTMessageRoomMember(
      com.aimluck.eip.cayenne.om.portlet.EipTMessageRoomMember obj) {
  ...
  public void addToEipTMessages(
      com.aimluck.eip.cayenne.om.portlet.EipTMessage obj) {
    addToManyTarget("eipTMessages", obj, true);
  }

  public void removeFromEipTMessages(
      com.aimluck.eip.cayenne.om.portlet.EipTMessage obj) {
