...
depends: [["provide", "dojox.encoding.bits"]],
defineResource: function(dojo){if(!dojo._hasResource["dojox.encoding.bits"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
