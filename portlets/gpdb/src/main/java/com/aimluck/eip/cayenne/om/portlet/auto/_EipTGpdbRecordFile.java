...
/** Class _EipTGpdbRecordFile was generated by Cayenne.
  * It is probably a good idea to avoid changing this class manually, 
  * since it may be overwritten next time code is regenerated. 
  * If you need to make any customizations, please use subclass. 
  */
public class _EipTGpdbRecordFile extends org.apache.cayenne.CayenneDataObject {
    ...
    public static final String GPDB_RECORD_ID_PROPERTY = "gpdbRecordId";
    ...
    public void setGpdbRecordId(Integer gpdbRecordId) {
        writeProperty("gpdbRecordId", gpdbRecordId);
    }
    public Integer getGpdbRecordId() {
        return (Integer)readProperty("gpdbRecordId");
    }
    ...
    public void setEipTGpdbRecord(com.aimluck.eip.cayenne.om.portlet.EipTGpdbRecord eipTGpdbRecord) {
        setToOneTarget("eipTGpdbRecord", eipTGpdbRecord, true);
    }

    public com.aimluck.eip.cayenne.om.portlet.EipTGpdbRecord getEipTGpdbRecord() {
        return (com.aimluck.eip.cayenne.om.portlet.EipTGpdbRecord)readProperty("eipTGpdbRecord");
    } 
