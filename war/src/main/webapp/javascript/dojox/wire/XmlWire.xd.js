...
depends: [["provide", "dojox.wire.XmlWire"],
["require", "dojox.data.dom"],
["require", "dojox.wire.Wire"]],
defineResource: function(dojo){if(!dojo._hasResource["dojox.wire.XmlWire"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
