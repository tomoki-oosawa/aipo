...
-- 20111116
UPDATE EIP_T_ACL_PORTLET_FEATURE SET FEATURE_ALIAS_NAME = 'スケジュール（設備の予約）操作' WHERE FEATURE_ID = 113 AND FEATURE_ALIAS_NAME = 'スケジュール（施設の予約）操作';
UPDATE EIP_T_ACL_ROLE SET ROLE_NAME = 'スケジュール（設備の予約）管理者' WHERE ROLE_ID = 3 AND ROLE_NAME = 'スケジュール（施設の予約）管理者';
-- 20111116
