...
depends: [["provide", "dojox.dtl.tag.loop"],
["require", "dojox.dtl._base"]],
defineResource: function(dojo){if(!dojo._hasResource["dojox.dtl.tag.loop"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
