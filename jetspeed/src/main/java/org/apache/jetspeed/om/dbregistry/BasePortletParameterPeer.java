...
public abstract class BasePortletParameterPeer extends BasePeer {
   ...
   *
   */
  private static final long serialVersionUID = 2555198989589272486L;
   ...
   *           into a TorqueException.
   */
  public static List<BaseObject> doSelect(PortletParameter obj)
      throws TorqueException {
   ...
   *           Primary key was not found in database.
   */
  public static BaseObject retrieveByPK(long pk) throws TorqueException,
   ...
   *           into a TorqueException.
   */
  protected static List<BaseObject> doSelectJoinPortletDbEntry(Criteria c)
      throws TorqueException {
    // Set the correct dbName if it has not been overridden
    ...
    for (int i = 0; i < rows.size(); i++) {
      ...
      for (int j = 0; j < results.size(); j++) {
        ...
        PortletDbEntry temp_obj2 =
          ((BasePortletParameter) temp_obj1).getPortletDbEntry();
