...
depends: [["provide", "dijit._base.typematic"]],
defineResource: function(dojo){if(!dojo._hasResource["dijit._base.typematic"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
