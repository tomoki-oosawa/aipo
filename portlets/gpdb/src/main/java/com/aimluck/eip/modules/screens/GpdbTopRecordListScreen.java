 ...
 *
 */
public class GpdbTopRecordListScreen extends GpdbScreen {

  /** logger */
  private static final JetspeedLogger logger = JetspeedLogFactoryService
    .getLogger(GpdbTopRecordListScreen.class.getName());
  ...
  protected void doOutput(RunData rundata, Context context) throws Exception {
    try {
      ...
      String layout_template = "portlets/html/ja/ajax-gpdb-top-record-list.vm";
      setTemplate(rundata, context, layout_template);

    } catch (Exception ex) {
      logger.error("[GpdbListScreen] Exception.", ex);
