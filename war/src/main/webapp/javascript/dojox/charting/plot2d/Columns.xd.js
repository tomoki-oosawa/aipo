...
depends: [["provide", "dojox.charting.plot2d.Columns"],
...
defineResource: function(dojo){if(!dojo._hasResource["dojox.charting.plot2d.Columns"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
