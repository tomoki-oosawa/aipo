...
public class Customize extends Action {
	...
	public void doPerform(RunData rundata) throws Exception {
		...
		if (jdata.getCustomizedProfile() == null) {
			ProfileLocator locator = (ProfileLocator) jdata.getProfile()
					.clone();
		...
		if (found != null) {
			...
			if (!JetspeedSecurity.checkPermission((JetspeedUser) jdata
					.getUser(), portalResource,
					JetspeedSecurity.PERMISSION_CUSTOMIZE)) {
				logger.warn("User " + jdata.getUser().getUserName()
