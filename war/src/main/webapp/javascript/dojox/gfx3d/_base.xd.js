...
depends: [["provide", "dojox.gfx3d._base"]],
defineResource: function(dojo){if(!dojo._hasResource["dojox.gfx3d._base"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
