...
depends: [["provide", "dojox.charting.themes.PlotKit.red"],
["require", "dojox.charting.Theme"]],
defineResource: function(dojo){if(!dojo._hasResource["dojox.charting.themes.PlotKit.red"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
