...
depends: [["provide", "dijit._editor.plugins.LinkDialog"],
...
["require", "dojo.i18n"],
["require", "dojo.string"],
["requireLocalization", "dijit._editor", "LinkDialog", null, "cs,de,es,fr,hu,it,ja,ko,ROOT,pl,pt,ru,zh,zh-tw", "cs,de,es,fr,hu,it,ja,ko,ROOT,pl,pt,ru,zh,zh-tw"]],
defineResource: function(dojo){if(!dojo._hasResource["dijit._editor.plugins.LinkDialog"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
