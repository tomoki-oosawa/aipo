...
depends: [["provide", "dojox.date.php"],
["require", "dojo.date"]],
defineResource: function(dojo){if(!dojo._hasResource["dojox.date.php"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
