...
depends: [["provide", "dojo.colors"]],
defineResource: function(dojo){if(!dojo._hasResource["dojo.colors"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
