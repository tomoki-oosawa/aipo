...
depends: [["provide", "dojo.date.stamp"]],
defineResource: function(dojo){if(!dojo._hasResource["dojo.date.stamp"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
