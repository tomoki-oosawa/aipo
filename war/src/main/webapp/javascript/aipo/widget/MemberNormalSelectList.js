...
dojo.declare("aipo.widget.MemberNormalSelectList", [dijit._Widget, dijit._Templated], {
    ...
    memberGroupUrl: "",
    changeGroupUrl: "",
    templateString:"<div id=\"${widgetId}\" widgetId=\"${widgetId}\" class=\"multiSelectBox\"><div class=\"head clearfix\"><div class=\"floatLeft\">${memberToTitle}</div><div class=\"floatRight\"><select  name=\"${groupSelectId}\" id=\"${groupSelectId}\"dojoAttachEvent=\"onchange:changeGroup\"></select></div></div><div class=\"body clearfix\"><div class=\"floatLeft\"><select size=\"5\" multiple=\"multiple\"  name=\"${memberToId}\" id=\"${memberToId}\"></select></div><div class=\"floatRight\"><select size=\"5\" multiple=\"multiple\" style=\"width:100%\" name=\"${memberFromId}\" id=\"${memberFromId}\"></select></div></div><div class=\"foot clearfix\"><div class=\"floatLeft\"><input id=\"${buttonRemoveId}\" name=\"${buttonRemoveId}\" type=\"button\" class=\"button\" value=\""+nlsStrings.DELETEBTN_STR+"\"/ dojoAttachEvent=\"onclick:onMemberRemoveClick\"></div><div class=\"floatRight\"><div style=\"display: none;\" id=\"${widgetId}-memberlist-indicator\" class=\"indicator alignleft\">読み込み中</div><input id=\"${buttonAddId}\" name=\"${buttonAddId}\" type=\"button\" class=\"button\" value=\""+nlsStrings.ADDBTN_STR+"\"/ dojoAttachEvent=\"onclick:onMemberAddClick\"></div></div></div></div>",
    postCreate: function(){
