...
depends: [["provide", "dojox.charting.Theme"],
["require", "dojox.charting._color"]],
defineResource: function(dojo){if(!dojo._hasResource["dojox.charting.Theme"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
