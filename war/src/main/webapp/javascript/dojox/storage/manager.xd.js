...
depends: [["provide", "dojox.storage.manager"]],
defineResource: function(dojo){if(!dojo._hasResource["dojox.storage.manager"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
