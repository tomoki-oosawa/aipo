...
depends: [["provide", "dojo.cldr.monetary"]],
defineResource: function(dojo){if(!dojo._hasResource["dojo.cldr.monetary"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
