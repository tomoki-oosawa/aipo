...
depends: [["provide", "dojox.charting.Chart2D"],
["require", "dojox.gfx"],
...
defineResource: function(dojo){if(!dojo._hasResource["dojox.charting.Chart2D"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
