 ...
 *
 */
public class GpdbItemChangeTurnFormJSONScreen extends ALJSONScreen {

  /** logger */
  private static final JetspeedLogger logger = JetspeedLogFactoryService
    .getLogger(GpdbItemChangeTurnFormJSONScreen.class.getName());
  ...
  protected String getJSONString(RunData rundata, Context context)
    ...
    try {
      ...
      logger.error("["
        + GpdbItemChangeTurnFormJSONScreen.class.toString()
        + "]", e);
    }
