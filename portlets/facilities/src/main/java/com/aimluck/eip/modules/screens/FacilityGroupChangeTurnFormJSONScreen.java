...
/**
 * 設備グループの順番情報をJSONデータとして出力するクラスです。 <br />
 *
 */
public class FacilityGroupChangeTurnFormJSONScreen extends ALJSONScreen {

  /** logger */
  private static final JetspeedLogger logger = JetspeedLogFactoryService
    .getLogger(FacilityGroupChangeTurnFormJSONScreen.class.getName());
  ...
  protected String getJSONString(RunData rundata, Context context)
    ...
    try {
      ...
      logger.error("["
        + FacilityGroupChangeTurnFormJSONScreen.class.toString()
        + "]", e);
    }
