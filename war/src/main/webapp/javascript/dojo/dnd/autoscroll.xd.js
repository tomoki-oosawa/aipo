...
depends: [["provide", "dojo.dnd.autoscroll"]],
defineResource: function(dojo){if(!dojo._hasResource["dojo.dnd.autoscroll"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
