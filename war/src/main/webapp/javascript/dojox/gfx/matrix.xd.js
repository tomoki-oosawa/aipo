...
depends: [["provide", "dojox.gfx.matrix"]],
defineResource: function(dojo){if(!dojo._hasResource["dojox.gfx.matrix"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
