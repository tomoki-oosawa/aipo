...
depends: [["provide", "dojox.lang.utils"]],
defineResource: function(dojo){if(!dojo._hasResource["dojox.lang.utils"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
