...
import com.aimluck.eip.gpdb.GpdbRecordMultiDelete;

/**
 *
 */
public class GpdbRecordFormJSONScreen extends ALJSONScreen {

  /** logger */
  private static final JetspeedLogger logger = JetspeedLogFactoryService
    .getLogger(GpdbRecordFormJSONScreen.class.getName());
  ...
  protected String getJSONString(RunData rundata, Context context)
    ...
    try {
      if (ALEipConstants.MODE_INSERT.equals(mode)) {
        ...
        // 一覧削除
        GpdbRecordMultiDelete delete = new GpdbRecordMultiDelete();
      ...
      logger.error("[GpdbRecordFormJSONScreen]", e);
    }
