...
depends: [["provide", "dijit.layout.TabContainer"],
["require", "dijit.layout.StackContainer"],
["require", "dijit._Templated"]],
defineResource: function(dojo){if(!dojo._hasResource["dijit.layout.TabContainer"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
