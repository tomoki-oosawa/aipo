...
depends: [["provide", "dojo.currency"],
["require", "dojo.number"],
["require", "dojo.i18n"],
["requireLocalization", "dojo.cldr", "currency", null, "ROOT,de,en,en-au,en-ca,en-us,es,fr,it,ja,ko,pt,zh", "ROOT,de,en,en-au,en-ca,en-us,es,fr,it,ja,ko,pt,zh"],
["require", "dojo.cldr.monetary"]],
defineResource: function(dojo){if(!dojo._hasResource["dojo.currency"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
