...
public abstract class BaseTurbineUserGroupRoleManager extends
   ...
   *
   */
  private static final long serialVersionUID = -7819116318060219767L;
  ...
  public static TurbineUserGroupRoleManager getManager() {
    return (TurbineUserGroupRoleManager) Torque.getManager(
  ...
  public static boolean exists(TurbineUserGroupRole obj) throws TorqueException {
