 ...
 *
 */
public class ToDoAdminSelectData extends
  ...
  protected Object getResultDataDetail(PortletEntry record)
      throws ALPageNotFoundException, ALDBErrorException {
    ToDoAdminDetailResultData rd = new ToDoAdminDetailResultData(record);
    rd.initField();
    return rd;
  }
  ...
  public PortletEntry selectDetail(RunData rundata, Context context)
    ...
    return CustomizeUtils.getPortletEntry(rundata, ToDoUtils.TODO_PORTLET_NAME);
  }
