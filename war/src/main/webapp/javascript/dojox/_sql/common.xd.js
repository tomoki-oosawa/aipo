...
depends: [["provide", "dojox._sql.common"],
["require", "dojox._sql._crypto"]],
defineResource: function(dojo){if(!dojo._hasResource["dojox._sql.common"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
