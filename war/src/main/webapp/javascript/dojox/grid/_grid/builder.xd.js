...
depends: [["provide", "dojox.grid._grid.builder"],
["require", "dojox.grid._grid.drag"]],
defineResource: function(dojo){if(!dojo._hasResource["dojox.grid._grid.builder"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
