...
public class FileIOScheduleCsvFileScreen extends ALCSVScreen {
  ...
  protected String getCSVString(RunData rundata) throws Exception {
    ...
    try {
      ...
      sb.append("\"2007/07/09\",\"16:30\",\"2007/07/09\",\"17:00\",会議室,営業会議,\"営業戦略と一週間の予定を確認\",\"山田 太郎\"");
      sb.append(LINE_SEPARATOR);
      sb.append("\"2007/07/06\",\"14:20\",\"2007/07/06\",\"15:00\",会議室,総務会議,\"一週間の反省と来週の予定を確認\",\"鈴木 太郎\"");
      sb.append(LINE_SEPARATOR);
      sb.append("\"2007/06/29\",\"08:30\",\"2007/06/29\",\"09:30\",会議室,部長会議,\"一ヶ月間の反省と今後の予定を確認\",\"鈴木 花子\"");
      sb.append(LINE_SEPARATOR);
      ...
      for (int i = 0; i < list.size(); i++) {
        ...
        sb.append(
            "\"" + time.getYear() + "/" + time.getMonth() + "/" + time.getDay()
                + "\"").append(",");
        sb.append("\"" + time.getHour() + ":" + time.getMinute() + "\"")
            .append(",");
