...
depends: [["provide", "dojox.string.tokenize"]],
defineResource: function(dojo){if(!dojo._hasResource["dojox.string.tokenize"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
