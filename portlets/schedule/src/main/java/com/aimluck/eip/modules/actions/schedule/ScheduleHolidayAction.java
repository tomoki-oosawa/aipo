 ...
 * 
 */
public class ScheduleHolidayAction extends ALBaseAction {

  /** logger */
  @SuppressWarnings("unused")
  private static final JetspeedLogger logger = JetspeedLogFactoryService
    .getLogger(ScheduleHolidayAction.class.getName());
  ...
  protected void buildNormalContext(VelocityPortlet portlet, Context context,
    ...
    if (getMode() == null) {
      doScheduleHoliday_list(rundata, context);
    }
  }

  public void doScheduleHoliday_list(RunData rundata, Context context)
      throws Exception {
    ...
    setTemplate(rundata, "schedule-holiday-list");
  }
