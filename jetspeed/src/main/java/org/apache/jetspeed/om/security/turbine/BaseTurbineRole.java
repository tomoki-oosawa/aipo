...
public abstract class BaseTurbineRole extends BaseObject {
   ...
   *
   */
  private static final long serialVersionUID = -6198394582758505443L;
  ...
  public void setRoleId(int v) throws TorqueException {
    ...
    if (collTurbineUserGroupRoles != null) {
      for (int i = 0; i < collTurbineUserGroupRoles.size(); i++) {
        ((TurbineUserGroupRole) collTurbineUserGroupRoles.get(i)).setRoleId(v);
      }
    }
  }
   ...
   */
  protected List<BaseObject> collTurbineRolePermissions;
  ...
  protected void initTurbineRolePermissions() {
    if (collTurbineRolePermissions == null) {
      collTurbineRolePermissions = new ArrayList<BaseObject>();
    }
  }
   ...
   */
  public List<BaseObject> getTurbineRolePermissions() throws TorqueException {
    if (collTurbineRolePermissions == null) {
   ...
   */
  public List<BaseObject> getTurbineRolePermissions(Criteria criteria)
      throws TorqueException {
    if (collTurbineRolePermissions == null) {
      if (isNew()) {
        collTurbineRolePermissions = new ArrayList<BaseObject>();
   ...
   * taken as input
   */
  public List<BaseObject> getTurbineRolePermissions(Connection con)
      throws TorqueException {
    if (collTurbineRolePermissions == null) {
      collTurbineRolePermissions =
   ...
   * TurbineRole.
   */
  protected List<BaseObject> getTurbineRolePermissionsJoinTurbineRole(
   ...
   * TurbineRole.
   */
  protected List<BaseObject> getTurbineRolePermissionsJoinTurbinePermission(
      Criteria criteria) throws TorqueException {
    if (collTurbineRolePermissions == null) {
      if (isNew()) {
        collTurbineRolePermissions = new ArrayList<BaseObject>();
   ...
   */
  protected List<BaseObject> collTurbineUserGroupRoles;
  ...
  protected void initTurbineUserGroupRoles() {
    if (collTurbineUserGroupRoles == null) {
      collTurbineUserGroupRoles = new ArrayList<BaseObject>();
    }
  }
   ...
   */
  public List<BaseObject> getTurbineUserGroupRoles() throws TorqueException {
    if (collTurbineUserGroupRoles == null) {
   ...
   */
  public List<BaseObject> getTurbineUserGroupRoles(Criteria criteria)
      throws TorqueException {
    if (collTurbineUserGroupRoles == null) {
      if (isNew()) {
        collTurbineUserGroupRoles = new ArrayList<BaseObject>();
   ...
   * taken as input
   */
  public List<BaseObject> getTurbineUserGroupRoles(Connection con)
      throws TorqueException {
    if (collTurbineUserGroupRoles == null) {
      collTurbineUserGroupRoles =
   ...
   * TurbineRole.
   */
  protected List<BaseObject> getTurbineUserGroupRolesJoinTurbineUser(
      Criteria criteria) throws TorqueException {
    if (collTurbineUserGroupRoles == null) {
      if (isNew()) {
        collTurbineUserGroupRoles = new ArrayList<BaseObject>();
   ...
   * TurbineRole.
   */
  protected List<BaseObject> getTurbineUserGroupRolesJoinTurbineGroup(
      Criteria criteria) throws TorqueException {
    if (collTurbineUserGroupRoles == null) {
      if (isNew()) {
        collTurbineUserGroupRoles = new ArrayList<BaseObject>();
   ...
   * TurbineRole.
   */
  protected List<BaseObject> getTurbineUserGroupRolesJoinTurbineRole(
      Criteria criteria) throws TorqueException {
    if (collTurbineUserGroupRoles == null) {
      if (isNew()) {
        collTurbineUserGroupRoles = new ArrayList<BaseObject>();
  ...
  public TurbineRole copy() throws TorqueException {
    ...
    List<BaseObject> v = getTurbineRolePermissions();
