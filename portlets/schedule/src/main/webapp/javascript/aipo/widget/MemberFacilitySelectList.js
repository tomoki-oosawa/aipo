...
dojo.declare("aipo.widget.MemberFacilitySelectList", [dijit._Widget, dijit._Templated], {
    ...
    changeGroupUrl: "",
    tmpPortretId: "",
    templateString: "<div id=\"${widgetId}\" widgetId=\"${widgetId}\" style=\"display: none\"><div class=\"auiPopup\" style=\"width:300px\"><div class=\"clearfix\"><div class=\"memberlistToTop\" >閲覧ユーザー一覧</div><div class=\"memberlistFromTop\"><select size=\"1\" style=\"width:100%\" name=\"${groupSelectId}\" id=\"${groupSelectId}\" dojoAttachEvent=\"onchange:changeGroup\"></select></div></div><div class=\"clearfix mb5\"><div class=\"memberlistToBody\" dojoAttachEvent=\"onclick:onSelectClick\"><select size=\"10\" multiple=\"multiple\" style=\"width:100%\" name=\"${memberToId}\" id=\"${memberToId}\"></select></div><div class=\"memberlistFromBody\" dojoAttachEvent=\"onclick:onSelectClick\"><select size=\"10\" multiple=\"multiple\" style=\"width:100%\" name=\"${memberFromId}\" id=\"${memberFromId}\"></select></div></div><div class=\"clearfix\"><div class=\"memberlistToBottom\"><div class=\"alignright\"><input id=\"${buttonRemoveId}\" name=\"${buttonRemoveId}\" type=\"button\" class=\"button\" value=\"削除\"/ dojoAttachEvent=\"onclick:onMemberRemoveClick\"></div></div><div class=\"memberlistFromBottom\"><div class=\"alignright\"><input id=\"${buttonAddId}\" name=\"${buttonAddId}\" type=\"button\" class=\"button\" value=\"＜ 追加\"/ dojoAttachEvent=\"onclick:onMemberAddClick\"></div></div></div> </div></div>\n",
    postCreate: function(){
    ...
    onSelectClick: function(){
    	dojo.addClass(this.domNode, "select");
    }
});
