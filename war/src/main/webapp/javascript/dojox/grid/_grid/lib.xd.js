...
depends: [["provide", "dojox.grid._grid.lib"]],
defineResource: function(dojo){if(!dojo._hasResource["dojox.grid._grid.lib"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
