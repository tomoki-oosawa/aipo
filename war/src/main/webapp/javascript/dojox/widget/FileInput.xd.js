...
depends: [["provide", "dojox.widget.FileInput"],
["require", "dijit.form._FormWidget"],
["require", "dijit._Templated"]],
defineResource: function(dojo){if(!dojo._hasResource["dojox.widget.FileInput"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
