...
depends: [["provide", "dojox.grid._grid.view"],
["require", "dijit._Widget"],
["require", "dijit._Templated"],
["require", "dojox.grid._grid.builder"]],
defineResource: function(dojo){if(!dojo._hasResource["dojox.grid._grid.view"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
