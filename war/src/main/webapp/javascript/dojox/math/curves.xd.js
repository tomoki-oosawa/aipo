...
depends: [["provide", "dojox.math.curves"]],
defineResource: function(dojo){if(!dojo._hasResource["dojox.math.curves"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
